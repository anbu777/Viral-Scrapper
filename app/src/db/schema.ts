...
export const scrapeRuns = sqliteTable("scrape_runs", {
  ...
  freeMode: integer("free_mode", { mode: "boolean" }).notNull().default(true),
...
export const videos = sqliteTable("videos", {
  ...
  selectedForAnalysis: integer("selected_for_analysis", { mode: "boolean" }).notNull().default(false),
...
export const scrapeRunItems = sqliteTable("scrape_run_items", {
  id: text("id").primaryKey(),
...
export const providerLogs = sqliteTable("provider_logs", {
  id: text("id").primaryKey(),
  provider: text("provider").notNull(),
